...
//     const [toggleDescription, setToggleDescription] = useState({});
    ...
    //         try {
    //             // const url = `https://api.themoviedb.org/3/movie/now_playing?api_key=${process.env.REACT_APP_MOVIE_DB_API_KEY}&language=en-US&page=${page}`;
    //             const url = `https://api.themoviedb.org/3/movie/now_playing?api_key=${import.meta.env.REACT_APP_MOVIE_DB_API_KEY}&language=en-US&page=${page}`;
...
//     useEffect(() => {
//         const fetchMovies = async () => {
//             const apiKey = import.meta.env.VITE_MOVIE_DB_API_KEY;  // Make sure to define the apiKey here
